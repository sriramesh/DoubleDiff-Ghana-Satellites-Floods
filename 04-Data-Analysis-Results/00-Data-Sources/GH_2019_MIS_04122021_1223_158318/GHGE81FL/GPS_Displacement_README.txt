Dataset: GHGE81FL
Displacement Restriction: Admin 2 (District)
...
No Restriction:
The displacement for this dataset was not restricted to national or sub-national boundaries.  Therefore, it was possible
for a cluster's coordinates to cross sub-national administrative or national level boundaries during the displacement process.

Restricted to DHS Regions:
The displacement is restricted so that the points stay within the country and within the DHS survey region. 
Therefore it was possible for a cluster's coordinates to cross a lower level (admin2 or admin3, etc.) adminstrative boundary
during the displacement process.

Restricted to admin1:
The displacement is restricted so that the points stay within the country, within the DHS survey region, and within
the admin1 area. Therefore, the displaced cluster's coordinates are located within the same admin0 and admin1 areas as the undisplaced cluster.
